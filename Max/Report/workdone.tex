...
The program was implemented with unit testing and composability in mind. It was important that the design supportted comparing the Full and Approximated correction . Also by using Python, multiple inherientance could be leveraged for instance for adding continous pixel value support to the \texttt{Full Correction Sampler}, the class \texttt{Continuous Full Correction Sampler} needed to inherit from \texttt{Continuous Approximate Correction Sampler} and  the \texttt{Full Correction Sampler}, with no code actually in the class.
