...
And similarly this can be seen to be $ \phi_i(h) = \sum_j
...
\(p(v_i=1|h) = \sigma_i(h)\). Thus _Gibbs sampling from a simple
...
from the second RBM's hidden layer, _plus a new bias} arising from
...
their weighted sums (\(\phi\)) _and adding in both their visible
...
\psi\_j = \log P\^{}_(h,v ; h\_j =1 ) - \log P\^{}}(h,v ; h\_j =
...
Now
\(\phi = \log \frac{1+e^{\phi}}{1+e^{-\phi}} = \log \frac{\sigma(\phi)}{\sigma(-\phi)}\)
(Marcus' magic identity). So the first term simplifies to $ \sum_i
v\_i W}\{ji\}$, which is the same as that in a ``vanilla RBM''.
...
dependency between the whole of \(h\), which is a worry.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{k+kn}{import} \PY{n+nn}{sympy} \PY{k+kn}{as} \PY{n+nn}{sp}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{reach} \PY{o}{=} \PY{l+m+mi}{40}
        \PY{n}{phi}\PY{p}{,} \PY{n}{eps} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{mgrid}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{n}{reach}\PY{p}{:}\PY{n}{reach}\PY{p}{:}\PY{l+m+mi}{100j}\PY{p}{,} \PY{o}{\PYZhy{}}\PY{n}{reach}\PY{p}{:}\PY{n}{reach}\PY{p}{:}\PY{l+m+mi}{100j}\PY{p}{]}
        \PY{n}{wgt} \PY{o}{=} \PY{l+m+mf}{3.0}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{n}{levels} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{n+nb}{abs}\PY{p}{(}\PY{n}{wgt}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mf}{0.5}\PY{p}{,} \PY{n+nb}{abs}\PY{p}{(}\PY{n}{wgt}\PY{p}{)}\PY{o}{+}\PY{l+m+mf}{0.5}\PY{p}{,} \PY{n+nb}{abs}\PY{p}{(}\PY{n}{wgt}\PY{p}{)}\PY{o}{/}\PY{l+m+mf}{10.}\PY{p}{)}
        ...
        \PY{n}{C} \PY{o}{=} \PY{n}{contourf}\PY{p}{(}\PY{n}{phi}\PY{p}{,} \PY{n}{eps}\PY{p}{,} \PY{n}{psi\PYZus{}correction\PYZus{}h0}\PY{p}{,} \PY{n}{levels}\PY{p}{,} \PY{n}{origin}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lower}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{n}{cmap}\PY{o}{=}\PY{n}{cm}\PY{o}{.}\PY{n}{get\PYZus{}cmap}\PY{p}{(}\PY{n}{cmap}\PY{p}{,} \PY{n+nb}{len}\PY{p}{(}\PY{n}{levels}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
        \PY{n}{colorbar}\PY{p}{(}\PY{p}{)}
        \PY{n}{title}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZdl{}h\PYZus{}j=0\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{)}
        \PY{n}{xlabel}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZdl{}}\PY{l+s}{\PYZbs{}}\PY{l+s}{phi\PYZus{}i\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{)}
        \PY{n}{ylabel}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZdl{}}\PY{l+s}{\PYZbs{}}\PY{l+s}{epsilon\PYZus{}i\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{)}
        \PY{n}{axis}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{equal}\PY{l+s}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}

            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}7}]:} (-40.0, 50.0, -40.0, 40.0)
\end{Verbatim}
        
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{PartRBM_thinking_files/PartRBM_thinking_16_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
_Q: What do we make of the resemblance between this and the
approximation, below?}

\subsubsection{SLEEP PHASE}\label{sleep-phase}

use ``regular'' Gibbs sampling _in each model separately} to sample
...
visible unit. So the Gibbs update is really simple in fact:
\[\psi_j = \sum_i W_{ji} (v_i - \sigma_{\phi+\epsilon} + \sigma_{\phi})\]

That's freakishly close to the learning rule stuff we got _in the
exact case\ldots{}} Weird / wonderful?

    \subsubsection{free phase is free}\label{free-phase-is-free}

And in the FREE PHASE the expected \(\psi\) is simply:
...
only the wake phase that needs any update to the vanilla Gibbs
\(\psi\).
...
ABOUT THIS SOME MORE.
    ...
    \subsubsection{better check that out}\label{better-check-that-out}
...
I seem to be claiming that $ \log \frac{\sigma(\phi)}{\sigma(\phi+W)}
\approx  W ; \sigma(\phi)$.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{n}{phi}\PY{p}{,} \PY{n}{eps} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{mgrid}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{n}{reach}\PY{p}{:}\PY{n}{reach}\PY{p}{:}\PY{l+m+mi}{100j}\PY{p}{,} \PY{o}{\PYZhy{}}\PY{n}{reach}\PY{p}{:}\PY{n}{reach}\PY{p}{:}\PY{l+m+mi}{100j}\PY{p}{]}
        \PY{n}{wgt} \PY{o}{=} \PY{l+m+mf}{2.0}
        \PY{n}{roughly} \PY{o}{=} \PY{n}{wgt} \PY{o}{*} \PY{p}{(}\PY{n}{sigmoid}\PY{p}{(}\PY{n}{phi}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{n}{sigmoid}\PY{p}{(}\PY{n}{phi}\PY{o}{+}\PY{n}{eps}\PY{p}{)}\PY{p}{)}
        
        \PY{n}{psi\PYZus{}correction\PYZus{}h0} \PY{o}{=} \PY{n}{calc\PYZus{}psi\PYZus{}correction}\PY{p}{(}\PY{n}{phi}\PY{p}{,} \PY{n}{eps}\PY{p}{,} \PY{n}{wgt}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{)}
        \PY{n}{contourf}\PY{p}{(}\PY{n}{phi}\PY{p}{,} \PY{n}{eps}\PY{p}{,} \PY{n}{roughly} \PY{o}{\PYZhy{}} \PY{n}{psi\PYZus{}correction\PYZus{}h0}\PY{p}{,} \PY{n}{levels}\PY{p}{,} \PY{n}{origin}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lower}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{n}{cmap}\PY{o}{=}\PY{n}{cm}\PY{o}{.}\PY{n}{get\PYZus{}cmap}\PY{p}{(}\PY{n}{cmap}\PY{p}{,} \PY{n+nb}{len}\PY{p}{(}\PY{n}{levels}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
        \PY{n}{colorbar}\PY{p}{(}\PY{p}{)}
        \PY{n}{title}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{approx correction \PYZhy{} exact correction}\PY{l+s}{\PYZsq{}}\PY{p}{)}
        \PY{n}{xlabel}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZdl{}}\PY{l+s}{\PYZbs{}}\PY{l+s}{phi\PYZus{}i\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{)}
        \PY{n}{ylabel}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZdl{}}\PY{l+s}{\PYZbs{}}\PY{l+s}{epsilon\PYZus{}i\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{)}
        \PY{n}{axis}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{equal}\PY{l+s}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
            ...
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}8}]:} (-40.0, 50.0, -40.0, 40.0)
\end{Verbatim}
        
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{PartRBM_thinking_files/PartRBM_thinking_22_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{n}{psi\PYZus{}correction\PYZus{}h1} \PY{o}{=} \PY{n}{calc\PYZus{}psi\PYZus{}correction}\PY{p}{(}\PY{n}{phi}\PY{p}{,} \PY{n}{eps}\PY{p}{,} \PY{n}{wgt}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}
        \PY{n}{contourf}\PY{p}{(}\PY{n}{phi}\PY{p}{,} \PY{n}{eps}\PY{p}{,} \PY{n}{roughly} \PY{o}{\PYZhy{}} \PY{n}{psi\PYZus{}correction\PYZus{}h1}\PY{p}{,} \PY{n}{levels}\PY{p}{,} \PY{n}{origin}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{lower}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{n}{cmap}\PY{o}{=}\PY{n}{cm}\PY{o}{.}\PY{n}{get\PYZus{}cmap}\PY{p}{(}\PY{n}{cmap}\PY{p}{,} \PY{n+nb}{len}\PY{p}{(}\PY{n}{levels}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
        \PY{n}{colorbar}\PY{p}{(}\PY{p}{)}
        \PY{n}{title}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{approx correction \PYZhy{} exact correction}\PY{l+s}{\PYZsq{}}\PY{p}{)}
        \PY{n}{xlabel}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZdl{}}\PY{l+s}{\PYZbs{}}\PY{l+s}{phi\PYZus{}i\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{)}
        \PY{n}{ylabel}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZdl{}}\PY{l+s}{\PYZbs{}}\PY{l+s}{epsilon\PYZus{}i\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{)}
...
\end{Verbatim}
            ...
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}9}]:} (-40.0, 50.0, -40.0, 40.0)
\end{Verbatim}
        
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{PartRBM_thinking_files/PartRBM_thinking_23_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \section{TODOs}\label{todos}

The above approximation was just pulled from the aether. It would be
great to derive it (or something better). To do this we need to simplify
\[ \log \big[ \frac{\sigma (\phi)}{\sigma(\phi+w)} \big] \;\; \approx w \times \text{something} \]
...
``Ideally'' by some measure the sigmoids here should also use a ``gain''
of \(\alpha\) as given. But that's probably not completely
crucial\ldots{}?

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{c}{\PYZsh{} testing the improved approximation}
         ...
         \PY{n}{plot}\PY{p}{(}\PY{n}{phi}\PY{p}{,} \PY{n}{np}\PY{o}{.}\PY{n}{log}\PY{p}{(}\PY{n}{sigmoid}\PY{p}{(}\PY{n}{phi}\PY{p}{)}\PY{o}{/}\PY{n}{sigmoid}\PY{p}{(}\PY{n}{phi}\PY{o}{+}\PY{n}{W}\PY{p}{)}\PY{p}{)}\PY{p}{,}\PY{l+s}{\PYZsq{}}\PY{l+s}{k}\PY{l+s}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plot}\PY{p}{(}\PY{n}{phi}\PY{p}{,} \PY{o}{\PYZhy{}}\PY{n}{W}\PY{o}{*}\PY{n}{sigmoid}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{n}{alpha}\PY{o}{*}\PY{p}{(}\PY{n}{phi}\PY{o}{+}\PY{n}{W}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}\PY{p}{,}\PY{l+s}{\PYZsq{}}\PY{l+s}{b}\PY{l+s}{\PYZsq{}}\PY{p}{)}
         \PY{k}{print}\PY{p}{(}\PY{n}{alpha}\PY{p}{)}
\end{Verbatim}
...
0.394645719261
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{PartRBM_thinking_files/PartRBM_thinking_26_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{c}{\PYZsh{} Now to put the \PYZdq{}eps\PYZdq{} term in too, to see the entire approximation}
         ...
         \PY{n}{plot}\PY{p}{(}\PY{n}{phi}\PY{p}{,} \PY{n}{truth}\PY{p}{,}\PY{l+s}{\PYZsq{}}\PY{l+s}{k}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{n}{phi}\PY{p}{,} \PY{n}{approx}\PY{p}{,}\PY{l+s}{\PYZsq{}}\PY{l+s}{b}\PY{l+s}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}

            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}11}]:} [<matplotlib.lines.Line2D at 0x3fb96d8>,
          <matplotlib.lines.Line2D at 0x3c114b8>]
\end{Verbatim}
        
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{PartRBM_thinking_files/PartRBM_thinking_27_1.png}
    \end{center}
    { \hspace*{\fill} \\}
